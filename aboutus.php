...
<div class="container" id="content">
    ...
    <div class="row">
        <div class="col-lg-4" align="justify">
            ...
            <p id="p1">Lifestyle store is a recognized leader in the industry, with a steadfast commitment to success and a record of achievement that continues a tradition of delivering excellence.<br><br>The company was founded in 2024 by Vishal and Siddheshwar to ease the process of ordering Plants. From those early days with just two employee, Lifestyle Store now has more than 50 employees, serving thousands of customers. <br><br>Lifestyle Store is guided by four principles: customer obsession rather than competitor focus, passion for invention, commitment to operational excellence, and long-term thinking.<br><br><h4><mark>Vision</mark></h4>To make the world a more stylish, colorful, and happier place. Bringing nature's beauty into your home, one plant at a time.<br><br><h4><mark>Mission</mark></h4>We strive to offer our customers the lowest possible prices, the best available selection, and the utmost convenience.
            </p>
        </div>
        <div class="col-lg-4" align="justify">
            ...
            <p id="p1">We strive to have a positive impact on customers, employees, small businesses, the economy, and communities.<br><br> We are smart, passionate builders with different backgrounds and goals, who share a common desire to always be learning and inventing on behalf of our customers.<br><br>We follow the following intensive growth strategies to match our competitors:<br>
                <ul>
                    ...
                    <li>Diversification:<br>Our objective is to achieve growth based on customer satisfaction.</li><br> 
                </ul>
            </p>
        </div>
    </div>
